...
```http
PUT http://api.markable.ai/catalogs/catalog-1/items HTTP/1.1
...
```shell
curl -X PUT http://api.markable.ai/catalogs/catalog-1/items \
...
`PUT http://api.markable.ai/catalogs/:catalogId/items/:itemId`
